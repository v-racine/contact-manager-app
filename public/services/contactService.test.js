...
const SAMPLE_CONTACTS = [
    { id: 1, full_name: "Alice Smith", email: "alice@work.com", tags: "work, client" },
    { id: 2, full_name: "Bob Johnson", email: "bob@home.com", tags: "friend" },
    { id: 3, full_name: "Charlie Brown", email: "charlie@work.com", tags: "work" },
    { id: 4, full_name: "Dan Smith", email: "dan@friend.com", tags: "friend, old" },
];
...
describe("ContactService Behavioral Unit Tests", () => {
    ...
    test("getContactDetail should propagate error if the API call fails", async () => {
        ...
        // ACT & ASSERT
        await expect(service.getContactDetail(99)).rejects.toThrow("Contact Not Found");
    });
    ...
    test("updateContact should call API and replace contact in cache by ID", async () => {
        ...
        const updatedData = { full_name: "Robert Johnson", email: "robert@work.com" };
        const apiResponse = { id: 2, full_name: "Robert Johnson", email: "robert@work.com", tags: "friend" };
    ...
    test("updateContact should throw error if no editing ID is set", async () => {        
        // ACT & ASSERT
        await expect(service.updateContact({})).rejects.toThrow("Cannot update contact: no ID set for editing.");
    ...
    test("updateContact should reload cache if contact is not found locally", async () => {
        ...
        MOCK_API.updateContact.mockResolvedValue(apiResponse);
        MOCK_API.getAllContacts.mockResolvedValue([...SAMPLE_CONTACTS, apiResponse]);
